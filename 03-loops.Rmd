...
```{r ex="activity-3a", type="solution", include=FALSE}
# loop from 10 to 20
for (i in 10:20)
{
  print(i)
...
```{r ex="activity-3b", type="solution", include=FALSE}
# Create a vector cars
...
```{r ex="activity-3c", type="solution", include=FALSE}
# Create a sequence of numbers from 1 to 3 and store it in a variable `x`.
x = seq(1:3)
...
```{r ex="activity-3d", type="solution", include=FALSE}
# Create a vector fruits 
...
```{r ex="activity-3e", type="solution", include=FALSE}
# Create a variable `b` and assign it the value 5
b = 5
