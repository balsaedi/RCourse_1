...
```{r ex="activity-1a", type="solution", include=FALSE}
# Add 2398 to 4653 
2398 + 4653
```
...
```{r ex="activity-1b", type="solution", include=FALSE}
# Subtract 15 from 30
30 - 15
```
...
```{r ex="activity-1c", type="solution", include=FALSE}
# Multiply 12 by 7
12 * 7
```
...
```{r ex="activity-1d", type="solution", include=FALSE}
# Divide 27 by 3
27/3
```
...
```{r ex="activity-1e", type="solution", include=FALSE}
# Assign -5 to m
m = -5
# Assign 20 to n
n = 20
...
```{r ex="activity-1f", type="solution", include=FALSE}
#i. `2+3-9/3+4*21-(21+14)`
2+3-9/3+4*21-(21+14)
